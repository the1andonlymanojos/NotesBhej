...
export default function AddRestaurant({
  ...
  return (
    <div className="fixed inset-0 z-[1200] flex items-end justify-center overflow-y-auto bg-neutral-950/35 p-0 backdrop-blur-sm sm:items-center sm:p-4">
      <section
        className={`${SURFACE} w-full max-w-lg overflow-hidden rounded-t-[26px] p-5 text-neutral-900 dark:text-white sm:rounded-[26px] sm:p-6`}
      >
        <div className="flex items-start justify-between">
          <div>
            <div className="text-xs font-semibold uppercase tracking-wide text-[#ef7d57]">Grow the Dex</div>
          ...
          <button
            onClick={onClose}
            aria-label="Close"
            className="grid size-8 shrink-0 place-items-center rounded-full text-neutral-500 transition hover:bg-black/5 hover:text-neutral-900 dark:hover:bg-white/10 dark:hover:text-white"
          >
            <X className="size-4" />
          </button>
        </div>
        ...
        {submitted ? (
          <div className="mt-5 rounded-2xl bg-[#ef7d57]/10 p-5">
          ...
          <>
            <div className="mt-5">
              ...
              {place && (
                <div className="mt-2 rounded-xl bg-black/[0.03] p-3 text-sm dark:bg-white/[0.04]">
                  ...
                  <div className="mt-0.5 text-neutral-500 dark:text-neutral-400">{place.address}</div>
                </div>
              )}
            </div>
                    ...
                    <button
                      ...
                      className={`rounded-full px-3 py-1.5 text-[13px] font-semibold transition ${
                        active
                          ...
                          : "bg-black/[0.05] text-neutral-600 hover:bg-black/[0.09] dark:bg-white/10 dark:text-neutral-300"
                      }`}
                    >
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              <label className="text-sm font-medium text-neutral-700 dark:text-neutral-200">
                ...
                <input
                  ...
                  className="mt-1.5 h-10 w-full rounded-xl border border-black/10 bg-white/70 px-3 text-sm font-normal outline-none focus:border-[#ef7d57] dark:border-white/15 dark:bg-white/5"
                />
              </label>
              <label className="text-sm font-medium text-neutral-700 dark:text-neutral-200">
                Price
            ...
            <button
              onClick={submit}
              disabled={submitting}
              className="mt-5 flex w-full items-center justify-center gap-2 rounded-xl bg-[#ef7d57] px-4 py-3 text-sm font-semibold text-white transition hover:bg-[#e06b45] disabled:opacity-60"
            >
